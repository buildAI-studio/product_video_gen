 ...
 * - All scene ids are unique because each carries a unique two-digit ordinal prefix.
...
export function generateStoryboard(
  ...
  routes.forEach((r, idx) => {
    ...
    // The two-digit ordinal prefix guarantees uniqueness across all scenes.
    const candidateId = `${twoDigit(sceneNum)}-${rawSlug}`;
